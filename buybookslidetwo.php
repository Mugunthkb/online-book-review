...
<div class="container mt-5">
  <div class="row">
    <!-- Image column -->
    <div class="col-md-6">
      <img src="../onlinebookdj/images/coverbooks/book2a.png" class="img-fluid" alt="Sample Image" height="300px" width="300px">
    </div>
    <!-- Content column -->
    <div class="col-md-6">
      <div class="content">
        <div class="author-description">
          <h2>Refrence physics book volume 1 for class 11th</h2>
          <h5>PRICE:100Rs</h5>
...
<span class="highlighted-text">Subject/Title</span>      Refrence physics book volume 1 for class 11th
<span class="highlighted-text">Type</span>               School Books (up to 12th)
<span class="highlighted-text">Category</span>           11th
<span class="highlighted-text">Author</span>             S.L. Arora
...
<div class="container">
  <div class="row">
      ...
      <div class="row">
        <p>Refrence physics book volume 1 for class 11th</p>
      </div>
      <div class="row">
