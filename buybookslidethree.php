...
<div class="container mt-5">
  <div class="row">
    <!-- Image column -->
    <div class="col-md-6">
      <img src="../onlinebookdj/images/coverbooks/book3a.png" class="img-fluid" alt="Sample Image" height="300px" width="300px">
    </div>
    <!-- Content column -->
    <div class="col-md-6">
      <div class="content">
        <div class="author-description">
          <h2>TARGET PSA (PROBLEM SOLVING ASSESSMENT) FOR CLASS 9</h2>
          <h5>PRICE:100Rs</h5>
          <button class="btn btn-primary "id="navigateButton">BUY NOW</button>
          <br>
          <span class="custom-font"><pre><span class="highlighted-text">Condition</span>          Excellent 
<span class="highlighted-text">Subject/Title</span>      TARGET PSA(Problem Solving Assessment)for Class-9
<span class="highlighted-text">Type</span>               School Books (up to 12th)
<span class="highlighted-text">Category</span>           9th
<span class="highlighted-text">Author</span>             Goyal Brothers Prakashan
...
<div class="container">
  <div class="row">
      ...
      <div class="row">
        <p>TARGET PSA (PROBLEM SOLVING ASSESSMENT) FOR CLASS 9</p>
      </div>
      <div class="row">
