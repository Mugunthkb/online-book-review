...
<div class="container mt-5">
  <div class="row">
    <!-- Image column -->
    <div class="col-md-6">
      <img src="../onlinebookdj/images/coverbooks/book1a.png" class="img-fluid" alt="Sample Image" height="300px" width="300px">
    </div>
    <!-- Content column -->
    <div class="col-md-6">
      <div class="content">
        <div class="author-description">
          <h2>SRIJAN ICSE Biology Book for Class 10</h2>
          <h5>PRICE:100Rs</h5>
          <button class="btn btn-primary "id="navigateButton">BUY NOW</button>
          <br>
          <span class="custom-font"><pre><span class="highlighted-text">Condition</span>          Fair 
<span class="highlighted-text">Subject/Title</span>      SRIJAN ICSE Biology Book for Class 10
<span class="highlighted-text">Type</span>               School Books (up to 12th)
<span class="highlighted-text">Category</span>           10th
<span class="highlighted-text">Author</span>             Veer Bala Rastogi
<span class="highlighted-text">Year</span>               2022
</pre></span>
</div>
      </div>
    </div>
...
<div class="container">
  <div class="row">
      ...
      <div class="row">
        <p>SRIJAN ICSE Biology Book for Class 10</p>
      </div>
      <div class="row">
